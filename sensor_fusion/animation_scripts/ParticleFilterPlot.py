...
def make_animation():
    ...
    init_belief = Gaussian(init_state, np.diag([0.8**2, 0.6**2, 0.05**2]))
    ...
    # prior_dist.set_data(particle_filter.proposal_distribution[:, 0], particle_filter.proposal_distribution[:, 1])
